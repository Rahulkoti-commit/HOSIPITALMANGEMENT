...
public class HospitalDAO {
    ...
    private static final String INSERT_PATIENT_SQL = "INSERT INTO Patient (PatientName, Age, Gender, AdmissionDate, Ailment, AssignedDoctor) VALUES (?, ?, ?, ?, ?, ?)";
    private static final String SELECT_PATIENT_BY_ID = "SELECT * FROM Patient WHERE PatientID=?";
    private static final String SELECT_ALL_PATIENTS = "SELECT * FROM Patient";
    private static final String DELETE_PATIENT_SQL = "DELETE FROM Patient WHERE PatientID=?";
    private static final String UPDATE_PATIENT_SQL = "UPDATE Patient SET PatientName=?, Age=?, Gender=?, AdmissionDate=?, Ailment=?, AssignedDoctor=? WHERE PatientID=?";
    private static final String SELECT_PATIENTS_BY_DATE_RANGE = "SELECT * FROM Patient WHERE AdmissionDate BETWEEN ? AND ?";
    private static final String SELECT_PATIENTS_BY_AILMENT = "SELECT * FROM Patient WHERE Ailment LIKE ?";
    private static final String SELECT_PATIENTS_BY_DOCTOR = "SELECT * FROM Patient WHERE AssignedDoctor=?";
